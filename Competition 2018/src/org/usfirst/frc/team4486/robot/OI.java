...
import org.usfirst.frc.team4486.robot.commands.RunClimberReverse;
...
public class OI {
	...
	public static JoystickButton auxClimbButton = new JoystickButton(manipulator,RobotMap.AUX_CLIMB_BUTTON);
	...
	public OI(){
		...
		auxClimbButton.whileHeld(new RunClimberReverse());
	}
